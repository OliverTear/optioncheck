        ...
        def read_option(e):
            ...
            if e.control.text == "Read":
                ...
                for i in range(setting[0][0]):
                    ...
                    onoff_cells = [ft.DataCell(chip), ft.DataCell(ft.Text(value="Option" + str(i),))]
                    onoff_rows.append(ft.DataRow(cells=onoff_cells))
                    if str(i+1) in on_list:
                        on__cells = [ft.DataCell(ft.Text(value="Option"+str(i+1))), ft.DataCell(ft.Text(value="Option" + str(i)))]
